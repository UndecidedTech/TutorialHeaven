...
<div class="appBackground pt-1">
  ...
  <img class="mb-4 brain" src="../assets/brain.png" alt="" width="100" height="100">
  <h1 class="h3 mb-3 font-weight-normal brain">Please sign in</h1>
  <input v-model="user.email" id="inputEmail" type="email" class="form-control d-none" placeholder="Email" required autofocus>
  <input v-model="user.username" id="inputUsername" class="form-control" placeholder="Username" required autofocus>
  ...
  <div class="checkbox mb-3">
    ...
    <label style="padding-left: 20%">
      <input @click="selectTrue()" type="checkbox" value="remember-me" > Sign Up
    </label>
  </div>
  <button id="signinButton" @click="loginUser()" class="btn btn-lg btn-primary btn-block" type="submit">Sign in</button>
